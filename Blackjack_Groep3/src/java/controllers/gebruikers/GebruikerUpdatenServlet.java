 ...
 * @author Xander
 */
public class GebruikerUpdatenServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nicknamenew = request.getParameter("nickname");
        int balance = Integer.parseInt(request.getParameter("credits"));
        String email = request.getParameter("email");
        String password = request.getParameter("password");
        int admin = Integer.parseInt(request.getParameter("admin"));
        
        String nickname = request.getAttribute("users").toString();
